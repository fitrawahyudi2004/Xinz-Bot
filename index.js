...
console.log(color(figlet.textSync('Xinz Bot-MD', {
		font: 'Pagga',
...
console.log(color('\n🐶 INSTAGRAM: fitra_wahyudi_','silver'))
console.log(color('🐶 GITHUB: Fitrawahyudi2004','silver'))
console.log(color('🐶 WA NUMBER: +6281262166032','silver'))
console.log(color('Hendraa','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6281262166032'))
    console.log(color('🐶', 'cyan'), color('Xinz Bot Is Online...', 'pink'))
    console.log(color('🐶', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('🐶','red'), color('Thanks For Using Xinz Bot', 'white'))
